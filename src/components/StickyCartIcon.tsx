...
export default function StickyCartIcon({ onClick }: StickyCartIconProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="fixed right-6 bottom-24 bg-green-500 hover:bg-green-600 text-white rounded-2xl shadow-2xl p-4 transition-all duration-300 hover:scale-110 z-40 group animate-bounce"
    >
